...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	if (isset($_GET["id"])) {
		$id = $_GET["id"];
		$re = $mysqli->query("SELECT * FROM `facturas` WHERE idFacturas = '".$id."'");
		$f=mysqli_fetch_array($re);
		$aid = $f['Alumnos_idAlumnos'];
		$cant = $f['total_factura'];
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Facturas</h2>
							<form action="<?php 
							if (isset($_GET["id"])) {
								echo "php/EditInvoices.php";
							} else {
								echo "php/CreateInvoices.php";
							}
							?>" method="POST" enctype="multipart/form-data">
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Alumno(id):</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="aid" name="aid" placeholder="Cantidad" value="<?php echo $aid; ?>" required>
										<!-- Si hay tiempo cambiar este campo por una lista con todos los alumnos inscritos -->
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Cantidad:</label>
									<div class="col-md-5 col-10">
										<input type="number" class="form-control" id="amount" name="amount" placeholder="Cantidad" value="<?php echo $cant; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Fecha:</label>
									<div class="col-md-5 col-10">
										<input type="date" class="form-control" id="Fecha" name="Fecha" step="1" min="2013-01-01" max="2030-12-31" value="<?php echo $date; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
