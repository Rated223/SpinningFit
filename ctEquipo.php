			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Lista de equipos</h2>
						...
						<div class="row mb-3">
		                    ...
		                    <a class="btn btn-success my-auto ml-auto mr-3 text-white" href="FormEquipos.php">
		                        Agregar equipo
		                    </a>
	                    </div>

						<?php
		                    $re2 = $mysqli->query("SELECT * FROM `equipo`");
		                    ...
		                    if(isset($_GET['buscar'])){
		                        $re = $mysqli->query("SELECT * FROM equipo WHERE `Administrador_idAdministrador`  LIKE '%".$_GET['buscar']."%' ORDER BY `idEquipo` ASC LIMIT $empieza, $cantidad_resultados");
		                    } else {
		                        $re = $mysqli->query("SELECT * FROM equipo ORDER BY `idEquipo` ASC LIMIT $empieza, $cantidad_resultados");
		                    }
						...
						<!--TABLA-->
							 <table class="table table-striped table-bordered table-sm table-hover">
								  <thead class="thead-dark bg-dark text-white">
								      ...
								      <th class="text-center col-auto">Administrador</th>
								      <th class="text-center col-auto">Nombre del Equipo</th>
								      <th class="text-center col-auto">Estado</th>
		                          ...
		                          ?> 
								    ...
								    <tr>
										<td class="text-center"><?php echo $f['idEquipo']; ?></td>
										<td class="text-center"><?php echo $f['Administrador_idAdministrador']; ?></td>
								        <td class="text-center"><?php echo $f['nombre_equipo']; ?></td>
								        <td class="text-center"><?php echo $f['estado_equipo']; ?></td>
								        <td class="text-center"><?php echo $f['fecha_equipo']; ?></td>
								      	 <td>
		                        			<a href="FormEquipos.php?id=<?php echo $f['idEquipo']; ?>" class="btn btn-info btn-sm">
		                                		<i class="icon-edit" aria-hidden="true"></i>
		                           			</a>
		                        		</td>

								       <td class="text-center">
		                            	<form action="php/DeleteEquipo.php" method="POST">
		                                	<button type="submit" class="btn btn-danger btn-sm" name="id" value="<?php echo $f['idEquipo']; ?>">
