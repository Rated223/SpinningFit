			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<div class="row mb-3">
							<h3 class="text-dark font-weight-bold mx-3 my-auto col-auto">Mantenimiento</h3>
		                    ...
		                    <a class="btn btn-success my-auto ml-auto mr-3 text-white" href="FormMaintenance.php">
		                        Agregar registro
		                    </a>
	                    </div>

						 <?php
		                    $re2 = $mysqli->query("SELECT * FROM `mantenimiento`");
		                    ...
		                    if(isset($_GET['buscar'])){
		                        $re = $mysqli->query("SELECT * FROM mantenimiento WHERE `nombre_mantenimiento`  LIKE '%".$_GET['buscar']."%' ORDER BY `idMantenimiento` ASC LIMIT $empieza, $cantidad_resultados");
		                    } else {
		                        $re = $mysqli->query("SELECT * FROM mantenimiento ORDER BY `idMantenimiento` ASC LIMIT $empieza, $cantidad_resultados");
		                    }
						...
						<table class="table table-striped table-bordered table-sm table-hover">
							<thead class="thead-dark bg-dark text-white">
								...
								<th class="text-center col-auto">clave</th>
		                ...
		                ?>  
							<tr>
		                        <td class="text-center"><?php echo $f['idMantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['Administrador_idAdministrador']; ?></td>
		                        <td class="text-center"><?php echo $f['nombre_mantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['apellido_mantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['correo_mantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['telefono_mantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['sueldo_mantenimiento']; ?></td>
		                        <td class="text-center"><?php echo $f['clave_mantenimiento']; ?></td>
		                        <td class="text-center">
		                        	<a href="/FormMaintenance.php?id=<?php echo $f['idMantenimiento']; ?>" class="btn btn-info btn-sm"">
		                                <i class="icon-edit" aria-hidden="true"></i>
		                            </a>
		                        </td>
		                        <td class="text-center">
		                            <form action="php/DeleteClient.php" method="POST">
		                                <button type="submit" class="btn btn-danger btn-sm" name="id" value="<?php echo $f['idMantenimiento']; ?>">
