			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<div class="row mb-3">
							<h3 class="text-dark font-weight-bold mx-3 my-auto col-auto">Administradores</h3>
						 ...
						 <?php
		                    ...
		                    if(isset($_GET['buscar'])){
		                        $re = $mysqli->query("SELECT * FROM administrador WHERE ` usuario_administrador`  LIKE '%".$_GET['buscar']."%' ORDER BY `idsdministrador` ASC LIMIT $empieza, $cantidad_resultados");
		                    } else {
		                        $re = $mysqli->query("SELECT * FROM administrador ORDER BY `idadministrador` ASC LIMIT $empieza, $cantidad_resultados");
		                    }
		                ...
		                ?>  
							<tr>
		                        ...
		                        <td class="text-center"><?php echo $f['telefono_administrador']; ?></td>
		                        <td class="text-center"><?php echo $f['sueldo_administrador']; ?></td>
		                        <td class="text-center"><?php echo $f['clave_administrador']; ?></td>
		                        <td class="text-center">
		                        	<form action="/EditAdmin.php" method="POST">
			                            <button type="submit" class="btn btn-info btn-sm" name="id" value="<?php echo $f['idadministrador']; ?>">
		                        ...
		                        <td class="text-center">
		                            <form action="php/DeleteAdmin.php" method="POST">
		                                <button type="submit" class="btn btn-danger btn-sm" name="id" value="<?php echo $f['idadministrador']; ?>">
