			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Notificaciones</h2>
						<div class="list-group text-left mx-5">
<?php  
	include 'php/conection.php';
	$re = $mysqli->query("SELECT *,DATE_FORMAT(fecha_notificacion, '%H:%i:%s  %d-%m-%Y') AS fecha_notificacion_F FROM `notificaciones` WHERE `id_usuario` = '".$_SESSION['id']."' AND `tipo_usuario` = '".$_SESSION['tipo']."'");
	while ($f=mysqli_fetch_array($re)) {
?>
							<a href="#" class="list-group-item list-group-item-action <?php if ($f['leido_notificacion']==0){echo "bg-light";} ?>">
								<div class="row">
									<div class="col-8 font-weight-bold">
										<h4><?php echo $f['titulo_notificacion'] ?></h4>
									</div>
									<div class="col-4" style="text-align: right;">
										<?php echo $f['fecha_notificacion_F'] ?>
									</div>
								</div>
								<div class="row">
									<div class="col">
										<?php echo $f['contenido_notificacion'] ?>
									</div>
								</div>
							</a>
<?php } ?>				
...
<?php
	$re = $mysqli->query("UPDATE `notificaciones` SET `leido_notificacion`='1' WHERE `id_usuario` = '".$_SESSION['id']."' AND `tipo_usuario` = '".$_SESSION['tipo']."'");
?>
