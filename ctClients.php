			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<div class="row mb-3">
							<h3 class="text-dark font-weight-bold mx-3 my-auto col-auto">Alumnos</h3>
						 ...
						 <?php
		                    ...
		                    if(isset($_GET['buscar'])){
		                        $re = $mysqli->query("SELECT * FROM alumno WHERE `usuario_alumno`  LIKE '%".$_GET['buscar']."%' ORDER BY `idalumno` ASC LIMIT $empieza, $cantidad_resultados");
		                    } else {
		                        $re = $mysqli->query("SELECT * FROM alumno ORDER BY `idalumno` ASC LIMIT $empieza, $cantidad_resultados");
		                    }
		                ...
		                ?>  
							<tr>
		                        <td class="text-center"><?php echo $f['idalumno']; ?></td>
		                        <td class="text-center"><?php echo $f['usuario_alumno']; ?></td>
		                        <td class="text-center"><?php echo $f['nombre_alumno']; ?></td>
		                        <td class="text-center"><?php echo $f['apellido_alumno']; ?></td>
		                        <td class="text-center"><?php echo $f['direccion_alumno']; ?></td>
		                        <td class="text-center"><?php echo $f['correo_alumno']; ?></td>
		                        <td class="text-center"><?php echo $f['telefono_alumno']; ?></td>
		                        <td class="text-center">
		                        	<form action="EditClients.php" method="POST">
			                            <button type="submit" class="btn btn-info btn-sm" name="id" value="<?php echo $f['idalumno']; ?>">
		                        ...
		                        <td class="text-center">
		                            <form action="php/DeleteClient.php" method="POST">
		                                <button type="submit" class="btn btn-danger btn-sm" name="id" value="<?php echo $f['idalumno']; ?>">
