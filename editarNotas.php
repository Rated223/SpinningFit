...
<html>
	...
	<meta name="author" content="" />
        ...
        <link rel="shortcut icon" type="image/x-icon" href="images/LOGO.png"> <!--Logo de pestañas-->
 ...
 <!--Captura datos-->
						<form action="php/editarNotas.php" method="POST" onsubmit="return validarNota()">
							...
							<div class="form-group row justify-content-left">
								...
								<div class="col-md-2 col-10">
									...
									<label for="user" class="col-md-3 col-12 form-control-label">Nota:</label>
                                                        <div class="col-md-10 col-10">
															<textarea type="text" class="form-control" id="notes" name="note" placeholder="Escriba su nota..."><?php
															include("php/importarNota.php");
															while($row = mysqli_fetch_array($resultado))
															{
															echo $row['descripcion_notas'];
															}
															?></textarea>
                                                        </div><br>                     
							    <div class="form-group row justify-content-center">
                                            <div class="col-sm-offset-2 col-sm-10">
												...
												<button type ="button" onclick="window.location.href = 'notas.php'" class="btn btn-secondary">Cancelar</button>							
                                            </div>
								</div>
						</form>
