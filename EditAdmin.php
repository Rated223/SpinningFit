...
<?php 
	...
	$id = $_POST['id'];
	$re = $mysqli->query("SELECT * FROM `administrador` WHERE `idadministrador` = '$id'");
							...
							<form action="php/EditAdmin.php" method="POST">
								<div class="form-group row justify-content-center">
									...
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="user" name="user" placeholder="Nombre de Usuario" value ="<?php echo $f['usuario_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="pass" class="col-md-2 col-12 form-control-label">Contraseña:</label>
									<div class="col-md-5 col-10">
										<input type="password" class="form-control" id="pass" name="pass" placeholder="Contraseña" value ="<?php echo $f['contrasena_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Confirmar contraseña:</label>
									<div class="col-md-5 col-10">
										<input type="password" class="form-control" id="pass2" name="pass2" placeholder="Contraseña" value ="<?php echo $f['contrasena_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Nombre:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="name" name="name" placeholder="Nombre" value ="<?php echo $f[' nombre_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Apellidos:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Apellidos" value ="<?php echo $f['apellido_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Dirección:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="address" name="address" placeholder="Dirección" value ="<?php echo $f['direccion_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Correo:</label>
									<div class="col-md-5 col-10">
										<input type="email" class="form-control" id="email" name="email" placeholder="Correo" value ="<?php echo $f['correo_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Telefono:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="phone" name="phone" placeholder="Telefono" value ="<?php echo $f['telefono_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Sueldo:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="salary" name="salary" placeholder="Sueldo" value ="<?php echo $f['sueldo_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Clave:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="key" name="key" placeholder="Clave" value ="<?php echo $f['clave_administrador']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
