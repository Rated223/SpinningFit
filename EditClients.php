...
<?php 
	...
	$id = $_POST['id'];
	echo "$id";
	$re = $mysqli->query("SELECT * FROM `alumno` WHERE `idalumno` = '$id'");
				...
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						<div class="mt-5 text-center colorlib-heading animate-box">
							<h2 class="text-dark">Editar datos de Alumno</h2>
							<form action="php/EditClients.php" method="POST">
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Nombre de Usuario:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="user" name="user" placeholder="Nombre de Usuario" value ="<?php echo $f['usuario_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="pass" class="col-md-2 col-12 form-control-label">Contraseña:</label>
									<div class="col-md-5 col-10">
										<input type="password" class="form-control" id="pass" name="pass" placeholder="Contraseña" value ="<?php echo $f['contrasena_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Confirmar contraseña:</label>
									<div class="col-md-5 col-10">
										<input type="password" class="form-control" id="pass2" name="pass2" placeholder="Contraseña" value ="<?php echo $f['contrasena_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Nombre:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="name" name="name" placeholder="Nombre" value ="<?php echo $f['nombre_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Apellidos:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Apellidos" value ="<?php echo $f['apellido_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Dirección:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="address" name="address" placeholder="Dirección" value ="<?php echo $f['direccion_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Correo:</label>
									<div class="col-md-5 col-10">
										<input type="email" class="form-control" id="email" name="email" placeholder="Correo" value ="<?php echo $f['correo_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Telefono:</label>
									<div class="col-md-5 col-10">
										<input type="text" class="form-control" id="phone" name="phone" placeholder="Telefono" value ="<?php echo $f['telefono_alumno']; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
