...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	if (isset($_GET["id"])) {
		$id = $_GET["id"];
		$re = $mysqli->query("SELECT * FROM `mantenimiento` WHERE idMantenimiento = '".$id."'");
		$f=mysqli_fetch_array($re);
		$name = $f['nombre_mantenimiento'];
		$lastname = $f['apellido_mantenimiento'];
		$mail = $f['correo_mantenimiento'];
		$phone = $f['telefono_mantenimiento'];
		$salary = $f['sueldo_mantenimiento'];
		$key = $f['clave_mantenimiento'];
	} else {
		$id = 0;
		$name = "";
		$lastname = "";
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Nuevo Personal de Mantenimiento</h2>
							<form action="<?php 
							if (isset($_GET["id"])) {
								echo "php/EditMaintenance.php";
							} else {
								echo "php/CreateMaintenance.php";
							}
							?>" method="POST" enctype="multipart/form-data">
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Nombre:</label>
									<div class="col-md-5 col-10">
										<input type="text" id="name" name="name" placeholder="Nombre" value="<?php echo $name; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Apellido:</label>
									<div class="col-md-5 col-10">
										<input type="text" id="lastname" name="lastname" placeholder="Apellido" value="<?php echo $lastname; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Correo:</label>
									<div class="col-md-5 col-10">
										<input type="mail" id="mail" name="mail" placeholder="Correo" value="<?php echo $mail; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Telefono:</label>
									<div class="col-md-5 col-10">
										<input type="text" id="phone" name="phone" placeholder="Telefono" value="<?php echo $phone; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Salario:</label>
									<div class="col-md-5 col-10">
										<input type="number" id="salary" name="salary" placeholder="Salario" value="<?php echo $salary; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
									<label for="user" class="col-md-2 col-12 form-control-label">Clave:</label>
									<div class="col-md-5 col-10">
										<input type="text" id="key" name="key" placeholder="Clave" value="<?php echo $key; ?>" required>
									</div>
								</div>
								<div class="form-group row justify-content-center">
