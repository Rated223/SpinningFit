  ...
  <!-- Facebook and Twitter integration -->
	...
	<?php if (isset($_GET["errorusuario"])){ ?>
            <script type="text/javascript">
                window.onload = function(){ window.alert("Se produjo un error desconocido al intentar iniciar sesión."); };
            </script>
    <?php } ?>
				...
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<form action="php/login.php" method="POST">
								...
								<div class="col-12">
									<div class="row justify-content-center">
										<div class="radio col-sm-2 col-12">
											<label>
												<input type="radio" name="Type" id="tipoCliente" value="alumno" checked>
												alumno
											</label>
										</div>
										<div class="radio col-sm-2 col-12">
											<label>
												<input type="radio" name="Type" id="tipoInstructor" value="instructor">
												Instructor
											</label>
										</div>
										<div class="radio col-sm-2 col-12">
											<label>
												<input type="radio" name="Type" id="tipoAdmin" value="administrador">
												Admin
											</label>
										</div>
									</div>	
							...
							<div class="form-group row justify-content-center">
								<label for="user" class="col-md-2 col-12 form-control-label">Usuario:</label>
