...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	if (isset($_GET["id"])) {
		$id = $_GET["id"];
		$re = $mysqli->query("SELECT * FROM `equipo` WHERE idEquipo = '".$id."'");
		$f=mysqli_fetch_array($re);
		$equipname = $f['nombre_equipo'];
		$est= $f['estado_equipo'];
		$date = $f['fecha_equipo'];
	} else {
		$id = 0;
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Equipos</h2>
						<p>Registra los equipos actuales en el gimnasio</p>
							<form action="<?php 
							if (isset($_GET["id"])) {
								echo "php/EditEquipos.php";
							} else {
								echo "php/CreateEquipos.php";
							}
							?>" method="POST" enctype="multipart/form-data">

								<div class="form-group row justify-content-center">
									<label for="nom_equipo" class="col-md-2 col-12 form-control-label">Equipo:</label>
									<div class="col-md-5 col-10">
										<input type="text" id="nom_equipo" name="nom_equipo" placeholder="Ej. Equipo1" value="<?php echo $equipname; ?>" required>
									</div>
								</div>

								<div class="form-group row justify-content-center">
									<label for="estado" class="col-md-2 col-12 form-control-label">Estado del equipo:</label>
  
									<div class="col-md-5 col-10">
										<input type="text" id="estado" name="estado" placeholder="Estado" value="<?php echo $est; ?>" required>
									</div>
								</div>

								<div class="form-group row justify-content-center">
									<label for="Fecha" class="col-md-2 col-12 form-control-label">Fecha:</label>
									<div class="col-md-5 col-10">
