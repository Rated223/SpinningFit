...
<html>
  ...
  <!-- Facebook and Twitter integration -->
	...
	if (isset($_GET["id"])) {
		$id = $_GET["id"];
		$re = $mysqli->query("SELECT * FROM `gastos` WHERE idGastos = '".$id."'");
		$f=mysqli_fetch_array($re);
		$cant = $f['cantidad_gasto'];
		$date = $f['fecha_gasto'];
	} else {
		$id = 0;
		$cant = "";
			...
			<div class="container">
				<div class="row">
					<div class="col-12 mt-5 bg-white rounded">
						...
						<h2 class="text-dark">Gastos</h2>
							<form action="<?php 
							if (isset($_GET["id"])) {
								echo "php/EditExpenses.php";
							} else {
								echo "php/CreateExpenses.php";
							}
							?>" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group row justify-content-center">
									...
									<div class="col-md-5 col-10">
										<input type="date" class="form-control" id="Fecha" name="Fecha" step="1" min="2013-01-01" max="2030-12-31" value="<?php echo $date; ?>">
									</div>
								</div>
								<div class="form-group row justify-content-center">
